...
/*#define MQTT_CRED*/
#ifdef MQTT_CRED
char *mqtt_id     = "FAYSSALs_mqtt";
char *mqtt_login  = "FAYSSAL";
char *mqtt_passwd = "PASSWORD";
#else
char *mqtt_id     = "FAYSSALs_mqtt";
char *mqtt_login  = "FAYSSAL";
char *mqtt_passwd = "PASSWORD";
...
//#define TOPIC_LIGHT "uca/M1/iot/light/test"
//#define TOPIC_TEMP  "uca/M1/iot/temp/test"
//#define TOPIC_LED   "uca/M1/iot/led/test"
#ifdef TLS_USE
